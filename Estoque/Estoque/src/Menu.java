...
public class Menu {
    ...
    private void cadastrar_usuario() {
        ...
        if (entradaTipo.equals("1")) {
            ...
            System.out.println("Entrada inválida para tipo. Tente novamente.");
            return;
        }
    ...
    public void menuPrincipal() {
        ...
        do {
            ...
            opcaoMenuPrincipal = sc.nextLine().trim(); 
            ...
            switch (opcaoMenuPrincipal) {
                ...
                case "0":
                    ...
                    break;
                default:
                    if (!opcaoMenuPrincipal.isEmpty()) { 
                        System.out.println("Opção inválida!");
                    }
            }
        } while (!opcaoMenuPrincipal.equals("0")); 
    }
}
