...
public class Estoque implements AcoesEstoque {
    ...
    private ArrayList<HistoricoAcao> historico = new ArrayList<>(); 
    ...
    Scanner sc = new Scanner(System.in);
     ...
     private void registrarHistorico(String acao, Produto produto, int quantidade) {
        if (usuarioLogado != null) {
            historico.add(new HistoricoAcao(usuarioLogado.getNome(), acao, produto.getNome(), quantidade));
        }
    }
